...
public interface AccessController<C extends Credentials, S extends SubjectIdentity, O extends OrganizationIdentity, F extends FunctionIdentity> {
   ...
   * @throws AuthenticationFailedException if credentials cannot be authenticated
   */
  void validate(C credentials) throws AuthenticationFailedException;

  /**
   * Check if given credentials give access to specified function
   * @param credentials credentials to check
   ...
   * @throws AuthenticationFailedException if credentials cannot be authenticated
   */
  boolean hasPermission(C credentials, F function) throws AuthenticationFailedException;
   ...
   * @throws AuthenticationFailedException if credentials cannot be authenticated
   */
  boolean hasPermission(C credentials, NamedFunction function) throws AuthenticationFailedException;
   ...
   * @throws AuthenticationFailedException if credentials cannot be authenticated
   */
  boolean hasPermission(C credentials, F function, O organization) throws AuthenticationFailedException;
   ...
   * @throws AuthenticationFailedException if credentials cannot be authenticated
   */
  boolean hasPermission(C credentials, NamedFunction function, O organization) throws AuthenticationFailedException;
   ...
   * @throws AuthenticationFailedException if credentials cannot be authenticated
   */
  Set<S> getSubjectIdentities(C credentials) throws AuthenticationFailedException;
   ...
   * @throws AuthenticationFailedException if credentials cannot be authenticated
   */
  Set<O> getAvailableOrganizations(C credentials) throws AuthenticationFailedException;
   ...
   * @throws AuthenticationFailedException if credentials cannot be authenticated
   * @throws AccessDeniedException if credentials have no access to specified organization
   */
  Set<O> getDescendingOrganizations(C credentials, O topLevelOrg) throws AuthenticationFailedException, AccessDeniedException;
